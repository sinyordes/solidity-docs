...
<span class="hljs-class"><span class="hljs-keyword">contract</span> <span class="hljs-title">Sabitler</span> </span>{
    <span class="hljs-comment">// sabit değişkenleri büyük harfe kodlama kuralı</span>
    <span class="hljs-comment">// constant özelliğine sahip bir değişkenin değeri değiştirilemez.</span>
